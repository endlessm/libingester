...
const expectedHatchMetadata = {
    ...
    'temporalCoverage': [new Date(1492545280000)],
    'title': 'Test Asset',
    'license': 'Proprietary',
...
describe('GalleryImageArticle', () => {
    it('can serialize out correctly', () => {
        ...
        asset.set_temporal_coverage([new Date(1492545280000)]);
    ...
    it('can pass metadata to constructor and set metadata at once', () => {
        ...
        const asset = new libingester.GalleryImageArticle(metadata);
        ...
        const moreMetadata = {
            ...
            read_more_text: 'More!',
            temporal_coverage: [new Date(1492545280000)],
            as_static_page: true,
        };
