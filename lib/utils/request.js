...
const _requestDefaults = _getRequestDefaults();
...
function _request (uri, options = {}) {
    ...
    return promiseRetry(async (retry, attempt) => {
        ...
        const response = await _requestDefaults(mergedOptions);
...
module.exports = {
    request: _request,
    requestDefaults: _requestDefaults,
};
