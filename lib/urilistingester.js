...
const IngesterV2 = require('./ingesterv2');
const Parser = require('./parser');
const { config } = require('./config');
const { ImplementationError } = require('./errors');

const BaseIngester = (config.hatchV2 ? IngesterV2 : Ingester);

class URIListIngester extends BaseIngester {
    get parserClass () {
        return Parser;
    }
    ...
    get uris () {
        throw new ImplementationError('You have to implement the uris() getter.');
    }
}
