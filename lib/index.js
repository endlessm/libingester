...
class GalleryVideoArticle extends BaseAsset {
    ...
    render() {
        ...
        console.log('woirking up til here!!');
        ...
        console.log('working halfway thru');
        this._body('.main-image-wrapper').append(`<div class="play-button-wrapper">
            ${playbutton_decoration.html('svg')}
        </div>`);
        console.log('YAY WORKED ALL THE WAY THRU');
        let document = mustache.render(template, {
            stylesheet: stylesheet.css,
            author: this._author,
            title: this._title,
