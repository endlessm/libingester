...
class GalleryVideoArticle extends BaseAsset {
    ...
    render() {
        const templatePath = path.join(__dirname, '..', 'data/assets/gallery-video-article.mst');
        const template = fs.readFileSync(templatePath, 'utf8');
...
class NewsArticle extends BaseAsset {
    ...
    render() {
        ...
        const templatePath = path.join(__dirname, '..', 'data/assets/news-article.mst');
        const template = fs.readFileSync(templatePath, 'utf8');

        const newsStylesheet = path.join(__dirname, '..', 'data/assets/news-stylesheet.scss');
