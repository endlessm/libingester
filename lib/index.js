...
class Hatch {
    ...
    _filter_duplicated_assets() {
        this._assets = this._assets.filter((asset, idx, arr) => {
            return arr.map(mapAsset => mapAsset.asset_id).indexOf(asset.asset_id) === idx;
        });
    }
    ...
    finish() {
        ...
        .then(() => this._filter_duplicated_assets())
