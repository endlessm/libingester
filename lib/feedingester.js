...
class FeedIngester extends URIListIngester {
    ...
    _doRetry (feedUrl, requestOptions, retry, attempt) {
    ...
    async _fetchRssPage (feed, page, items, allLinks, requestOptions) {
        ...
        const feedJson = await this._fetchRssJsonWithRetry(feedUrl, requestOptions);
