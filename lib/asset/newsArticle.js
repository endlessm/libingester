...
class NewsArticle extends BaseAsset {
    ...
    set_metadata(metadata) {
        ...
        if (typeof metadata.authors !== 'undefined') {
            this.set_authors(metadata.authors);
        }
        if (typeof metadata.main_image !== 'undefined') {
            this.set_main_image(metadata.main_image);
        }
        if (typeof metadata.section !== 'undefined') {
            this.set_section(metadata.section);
        }
        ...
        if (typeof metadata.lede !== 'undefined') {
            this.set_lede(metadata.lede);
        }
        ...
        if (typeof metadata.read_more_link !== 'undefined') {
            this.set_read_more_link(metadata.read_more_link);
        }
    }
