...
class BaseAsset {
    ...
    set_metadata(metadata) {
        ...
        if (typeof metadata.synopsis !== 'undefined') {
            this.set_synopsis(metadata.synopsis);
        }
        if (typeof metadata.thumbnail !== 'undefined') {
            this.set_thumbnail(metadata.thumbnail);
        }
        if (typeof metadata.canonical_uri !== 'undefined') {
            this.set_canonical_uri(metadata.canonical_uri);
        }
        if (typeof metadata.last_modified_date !== 'undefined') {
            this.set_last_modified_date(metadata.last_modified_date);
        }
        if (typeof metadata.date_published !== 'undefined') {
            this.set_date_published(metadata.date_published);
        }
        if (typeof metadata.sequence_number !== 'undefined') {
            this.set_sequence_number(metadata.sequence_number);
        }
        if (typeof metadata.license !== 'undefined') {
            this.set_license(metadata.license);
        }
        if (typeof metadata.tags !== 'undefined') {
            this.set_tags(metadata.tags);
        }
    }
