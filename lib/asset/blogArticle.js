...
class BlogArticle extends BaseAsset {
    get ALLOWED_METADATA() {
        const allowed = ['author', 'main_image', 'main_image_caption', 'body', 'custom_scss',
                         'read_more_text', 'as_static_page'];
     ...
     * @param {string} metadata.author - See {@link BlogArticle#set_author}.
     * @param {ImageAsset} metadata.main_image - See {@link BlogArticle#set_main_image}.
     * @param {string} metadata.main_image_caption - See {@link BlogArticle#set_main_image_caption}.
     * @param {(string|Cheerio)} metadata.body - See {@link BlogArticle#set_body}.
     * @param {string} metadata.custom_scss - See {@link BlogArticle#set_custom_scss}.
     * @param {string} metadata.read_more_text - See {@link BlogArticle#set_read_more_text}.
     * @param {boolean} metadata.as_static_page - See {@link BlogArticle#set_as_static_page}.
     */
    set_metadata(metadata) {
        ...
        if (typeof metadata.main_image_caption !== 'undefined') {
            this.set_main_image_caption(metadata.main_image_caption);
        }
        ...
        if (typeof metadata.read_more_text !== 'undefined') {
            this.set_read_more_text(metadata.read_more_text);
        }
        if (metadata.as_static_page) {
